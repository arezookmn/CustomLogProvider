...
public class LogTestController: ControllerBase
{
    ...
    public IActionResult Get()
    {
        ...
        _logger.LogTrace(eventId: 1, message: "This is a trace message", exception: null);
        _logger.LogInformation(eventId: 2, message: "This is an information message", exception: null);
        _logger.LogWarning(eventId: 3, message: "This is a warning message", exception: null);
